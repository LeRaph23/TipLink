...
// Pure URL helpers live in their own module so client components can use
// them without pulling in the Places API code.
import { buildGoogleReviewUrl } from './google-review-url';
export { buildGoogleReviewUrl, normalizeGoogleReviewUrl } from './google-review-url';
