    ...
    line_items: [
      {
        price_data: {
          ...
          product_data: {
            name: `TipLink SmartTag — Pack ${pack.toUpperCase()} (${packDef.quantity} tags)`,
            description: `Pack ${pack.toUpperCase()} · ${packDef.quantity} SmartTags NFC pré-configurés · 2 % de commission sur les pourboires`,
          },
        },
        quantity: 1,
      },
